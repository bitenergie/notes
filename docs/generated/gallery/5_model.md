...
[:fontawesome-solid-download: Download Python source code: 5_model.py](./5_model.py){ .md-button .center}

[:fontawesome-solid-download: Download Jupyter notebook: 5_model.ipynb](./5_model.ipynb){ .md-button .center}
